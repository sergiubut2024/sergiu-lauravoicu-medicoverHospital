<%@page import="in.co.hospital.mgt.sys.controller.ReceptionistCtl"%>
...
<section  class="intro">
          ...
          <div class="row">
            ...
            scope="request"></jsp:useBean>
                    ...
                    <div class="panel-body">
                      <form action="<%=HMSView.RECEPTIONIST_CTL%>" method="post"  >
 ...
 %>
                          ...
                          <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                              <label>Date Of Birth</label>
                               <input type="text" name="dob"  placeholder="Enter Date (MM/dd/yyyy)" class="form-control input-md"  value="<%=DataUtility.getDateString(bean.getDob())%>" >
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="jDate"  class="form-control input-md" placeholder="Enter (dd/MM/yyyy)" value="<%=DataUtility.getStringData(bean.getJoiningDate()) %>" >
                              <div><font
                        ...
                        color="red"> <%=ServletUtility.getErrorMessage("city", request)%></font></div>
                         ...
                         <div class="row">
                          ...
                          <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                              <label>Address</label>
                                <textarea rows="3" cols="5"  placeholder="Enter Address" name="address" class="form-control input-md" ><%=DataUtility.getStringData(bean.getAddress()) %></textarea> 
                              <div><font
                        ...
                        <input type="submit" value="<%=ReceptionistCtl.OP_SAVE%>" name="operation" class="btn btn-skin btn-block btn-lg">
