...
/**
 * Servlet implementation class ReceptionistCtl
 */
@WebServlet(name="ReceptionistCtl",urlPatterns={"/ctl/ReceptionistCtl"})
public class ReceptionistCtl extends BaseCtl {
    ...
    protected boolean validate(HttpServletRequest request) {
		log.debug("ReceptionistCtl validate method start");
        boolean pass = true;
        ...
        log.debug("ReceptionistCtl validate method end");
        return pass;
    }
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		...
		log.debug("ReceptionistCtl Method populatebean Started");

		UserBean bean = new UserBean();

		bean.setId(DataUtility.getLong(request.getParameter("id")));

		bean.setRoleId(RoleBean.RECEPTIONIST);
		...
		log.debug("ReceptionistCtl Method populatebean Ended");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		log.debug("ReceptionistCtl doGet method start"); 
		String op = DataUtility.getString(request.getParameter("operation"));
		   ...
		   UserModel model = new UserModel();
			...
			log.debug("ReceptionistCtl doGet method end");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		log.debug("ReceptionistCtl doPost method start");
		String op=DataUtility.getString(request.getParameter("operation"));
		UserModel model=new UserModel();
		long id=DataUtility.getLong(request.getParameter("id"));
		...
		try {
			model.delete(bean);
			ServletUtility.redirect(HMSView.RECEPTIONIST_LIST_CTL, request, response);
		} catch (ApplicationException e) {
			ServletUtility.handleException(e, request, response);
			e.printStackTrace();
		}
		...
		ServletUtility.redirect(HMSView.RECEPTIONIST_CTL, request, response);
		return;
}
				
		
		ServletUtility.forward(getView(), request, response);
		 log.debug("ReceptionistCtl doPost method end");
	}

	@Override
	protected String getView() {
		// TODO Auto-generated method stub
		return HMSView.RECEPTIONIST_VIEW;
	}
